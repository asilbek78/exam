        ...
        <div className="container h-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 pb-10 mt-7 w-[91%] mx-auto">
            {seven?.uzbektaomlar?.map((item, id) => (
              <div
                key={id}
                className="gap-2 hover:shadow-md dark:bg-[#0f152a] hover:shadow-black h-[460px] max-w-[350px] bg-white group border rounded-lg shadow-sm shadow-black flex flex-col p-4"
              >
                <img
